...
1. https://www.frankdigital.com.au/
2. https://demos.creative-tim.com/material-kit-pro-react/#/blog-post


# Sections:

1. Home page 
    1.1 Intro to company
    1.2 Services you provide
    1.3 Cool images with overlay, of case studies
    1.4 Tiles (gist of multiple things, including a blog, a case study, social media post, review etc.)
    1.5 "Get In Touch" like https://www.frankdigital.com.au/ with address and contact.
    1.6 Footer, navigation links and social media handles

2. Work
    2.1 All case studies (With a clickable image/video view)
    2.2 That's it

3. Blog
    3.1 Blog List with gist of content
    3.2 Blog View (of the entire blog written)

4. About Us
    4.1 Company Values
    4.2 Company Processes and Practices (from reference)
    4.3 Team Intro (from reference)
    Our Values (1 chhota paragraph)
    Picture
    TWD Team
    (1 chhota paragraph)
    Picture
...
5. Login page
    5.1 Predefined credentials, used to add the following:
        5.1.1 New Blog post
        5.1.2 New Case Study

===================

# Issues
1. NOT SECURE. Credential storage.
